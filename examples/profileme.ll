...
define void @DynamicString_destroy(ptr nocapture noundef %0) local_unnamed_addr #0 {
...
; Function Attrs: mustprogress noinline nounwind ssp willreturn uwtable(sync)
define void @DynamicString_init(ptr nocapture noundef %0, i32 noundef %1) local_unnamed_addr #0 {
...
; Function Attrs: mustprogress noinline nounwind ssp willreturn uwtable(sync)
define void @DynamicString_append(ptr nocapture noundef %0, i8 noundef signext %1) local_unnamed_addr #0 {
...
define range(i32 0, 2) i32 @main(i32 noundef %0, ptr nocapture noundef readonly %1) local_unnamed_addr #5 {
